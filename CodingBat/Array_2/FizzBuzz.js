...
let output = fizzBuzz(1, 6);
console.log("Output: " + output);
console.log(output.join("") == ["1", "2", "Fizz", "4", "Buzz"].join(""));

output = fizzBuzz(1, 8);
console.log("Output: " + output);
console.log(output.join("") == ["1", "2", "Fizz", "4", "Buzz", "Fizz", "7"].join(""));

output = fizzBuzz(1, 11);
console.log("Output: " + output);
console.log(output.join("") == ["1", "2", "Fizz", "4", "Buzz", "Fizz", "7", "8", "Fizz", "Buzz"].join(""));
